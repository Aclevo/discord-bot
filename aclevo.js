...
bot.on('ready', () => {
            ...
            if (message.content.includes(config.filterwords)) {
                message.delete()
            ...
            } else if (message.content.startsWith(prefix + "userpic")) {
                message.reply("Here is your avatar URL: " + message.author.avatarURL)
            } else if (message.content.startsWith(prefix + "botpic")) {
            ...
            else if (message.content.startsWith(prefix + "lockdown on")) {
                if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.reply(":x: :: You do not have the permission 'MANAGE_MESSAGES' therefore you cannot use this command.")
                if (message.content.contents)
                    var reason = args.slice(1).join(' ')
                var modlog = message.guild.channels.get("291317582663909378")
            ...
            // return message.reply("Sorry. I'm afraid I can't help you.")
